...
class WhatsAppRestaurantAgent:
    ...
    def _search_food_tool_logic(self, query: str, location: str = "", lat: float | None = None, lon: float | None = None) -> str:
        ...
        try:
            ...
            return f"Found items: {result}. When you reply to the user, give them the link format: https://zahi-trips.vercel.app/restaurants/<slug>?focus=<id>&add=1"
        except Exception as e:
            print(f"[SQL ERROR]: {e}")
    ...
    def _search_hotels_tool_logic(self, query: str, location: str = "", lat: float | None = None, lon: float | None = None) -> str:
        ...
        try:
            ...
            return f"Found hotels: {result}. When you reply to the user, give them the link format: https://zahi-trips.vercel.app/hotels/<slug>"
        except Exception as e:
            print(f"[SQL ERROR]: {e}")
    ...
    def _search_cabs_tool_logic(self, location: str = "", lat: float | None = None, lon: float | None = None) -> str:
        ...
        try:
            ...
            return f"Found cabs: {result}. When you reply, give them the link format: https://zahi-trips.vercel.app/cabs"
        except Exception as e:
            print(f"[SQL ERROR]: {e}")
    ...
    def _search_flights_tool_logic(self, destination: str, origin: str = "") -> str:
        ...
        try:
            ...
            return f"Found flights: {result}. When you reply, give them the link format: https://zahi-trips.vercel.app/flights"
        except Exception as e:
            print(f"[SQL ERROR]: {e}")
    ...
    def _create_agent(self):
        ...
        prompt = ChatPromptTemplate.from_messages([
            ...
            - When you find food, give the link: https://zahi-trips.vercel.app/restaurants/<slug>?focus=<id>&add=1
            - When you find a hotel, give the link: https://zahi-trips.vercel.app/hotels/<slug>
            - When you find a cab, give the link: https://zahi-trips.vercel.app/cabs
            - When you find a flight, give the link: https://zahi-trips.vercel.app/flights
