  ...
  return (
    ...
    >
      <div className="fade-up">
        <p className="text-xs uppercase tracking-[0.24em] text-[#a6633b]">Forgot password</p>
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-4 fade-up">
        <label className="block">
          <span className="mb-2 block text-sm font-medium text-[#3f342a]">Email address</span>
